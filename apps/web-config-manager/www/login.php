...
<title>TruLink Configuration Manager</title>
		...
		<div>
					<div class="loginbox">
						<div class="loginbox-top" >
							<img class="logo" title="Aware360 - TruLink Configuration Manager"
								alt="Aware360" src="images/aware360full_logo.png" />
						</div>
						<div class="loginbox-mid">
						TruLink Configuration Manager
						</div>
						...
						<div class="loginbox-bot">
							<form method="post" id="login">
								...
								<div class="row1">
									<span class="loginbox-input"><input
										type="text" size="26" name="user" autocorrect="off" autocapitalize="none">
									<br/>
								...
								<div class="row1">
									<span class="loginbox-input"><input
										type="password" size="26" name="pass">
									<br/>
