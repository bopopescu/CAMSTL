...
<?php require_once $_SERVER['DOCUMENT_ROOT'].'inc/display_controller.inc'; ?>
		<div class="item-1">
			<img class="logo" alt="Aware360" src="/images/aware360_logo.png" />
		</div>

		<div class="item-5">
			<a id="logout" href="/logout.php"><img title="Logout" alt="Logout" src="/images/logouticon.png"
				width="35px" height="35px" border="0" /><br /><span
				style="margin-left: 15px;">Logout</span></a>
		</div>

		<!-- active reboot icon -->
		<div class="item-2">
			<a id="reboot" href="/reboot.php"><img title="Reboot" alt="Reboot"
				src="/images/rebooticon.png" width="35px" height="35px" border="0"/><br />
			<span>Reboot</span></a>
		</div>
		...
		<div class="item-6">
			...
			<script type="text/javascript">
    			    $("#clock").clock({"format":"24", "timezone":"utc", "timestamp":<?php echo $timestamp*1000; ?>});
        	</script>
				<?php
