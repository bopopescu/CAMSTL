				...
				<div class="contentblock2">
					...
					<form id="ethernet" method="post" action="/inc/ethernet_processor.php">
							...
							<div class="row">
								...
								<span class="formw">
									<input type="text" size="1" value="<?php echo $emac[0] ?>" readonly="readonly">:
									<input type="text" size="1" value="<?php echo $emac[1] ?>" readonly="readonly">:
									<input type="text" size="1" value="<?php echo $emac[2] ?>" readonly="readonly">:
									<input type="text" size="1" value="<?php echo $emac[3] ?>" readonly="readonly">:
									<input type="text" size="1" value="<?php echo $emac[4] ?>" readonly="readonly">:
									<input type="text" size="1" value="<?php echo $emac[5] ?>" readonly="readonly">
								</span>
							</div>
							<div class="row">
						...
						<div class="row">
							...
							<span class="formw">
<?php
							debug('(ethernet/index.php) $edhcp_state info',$edhcp_status); 
?>
